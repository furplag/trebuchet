...
public interface ThrowableConsumer<T> extends Consumer<T> {
  ...
  static <T, E extends Throwable> ThrowableConsumer<T> of(final Consumer<? super T> consumer, final BiConsumer<? super T, ? super E> fallen) {
    ...
    return (t) -> {/* @formatter:off */try {consumer.accept(t);} catch (Throwable e) {Objects.requireNonNullElse(fallen, (x, ex) -> {/* do nothing . */}).accept(t, (E) e);}/* @formatter:off */};
  }
  ...
  static <T> void orElse(final T t, final Consumer<? super T> consumer, final Consumer<? super T> fallen) {
    orElse(t, consumer, (x, ex) -> Objects.requireNonNullElse(fallen, (x0) -> {/* do nothing . */}).accept(x));
  }
