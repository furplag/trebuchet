 ...
 *
 */
public interface SuppressOperator {
  ...
  static <T> T tryOut(final T t, final Function<T, T> functional) {
    return Suppressor.orElse(t, functional, t);
  }
   ...
   * @return the result of {@link BinaryOperator#apply(Object, Object) functional.apply(t1, t2)} if done it normally, or t1 if error occured
   * @see jp.furplag.function.Trebuchet.ThrowableBinaryOperator
   */
  static <T> T tryOut(final T t1, final T t2, final BinaryOperator<T> functional) {
    return Suppressor.orElse(t1, t2, functional, t1);
  }
   ...
   * @return the result of {@link BiFunction#apply(Object, Object) functional.apply(t, u)} if done it normally, or t if error occured
   * @see jp.furplag.function.Trebuchet.ThrowableBiFunction
   */
  static <T, U> T tryOut(final T t, final U u, final BiFunction<T, U, T> functional) {
    return Suppressor.orElse(t, u, functional, t);
  }
